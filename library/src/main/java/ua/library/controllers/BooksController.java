...
import ua.library.services.BooksService;
...
public class BooksController {
    ...
    public String index(Model model, @RequestParam(value = "page",
        ...
        if (page == null || booksPerPage == null)
            ...
            model.addAttribute("books", booksService.findWithPagination
                    (page, booksPerPage, sortByYear));

        return "books/index";
    }

    @GetMapping("/{id}")
    public String show(@PathVariable("id") int id, Model model, @ModelAttribute("person")
            Person person) {
