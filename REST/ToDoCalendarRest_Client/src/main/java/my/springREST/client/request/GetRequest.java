...
public class GetRequest {
    ...
    public void get(String request_url, String username, String password) throws JsonProcessingException {
        try {
            ...
            if (authenticationResponse.getStatusCode().equals(HttpStatus.OK)) {
                ...
                ResponseEntity<String> response = restTemplate.exchange(request_url, HttpMethod.GET, jwtEntity,
                        String.class);
