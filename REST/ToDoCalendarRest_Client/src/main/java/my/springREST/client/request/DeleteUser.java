...
public class DeleteUser {
    ...
    private static final String DELETE_USER_URL = "http://localhost:8080/person/";


    public void deleteUser(int id, String user, String password) throws JsonProcessingException {
        try {
            ...
            if (authenticationResponse.getStatusCode().equals(HttpStatus.OK)) {
                ...
                ResponseEntity<String> response = restTemplate.exchange(DELETE_USER_URL + id, HttpMethod.DELETE, jwtEntity,
                        String.class);
    ...
    private User getAuthenticationUser(String user,String password) {
